...
impl Card {
    ...
    pub fn gains_block(&self) -> bool {
        // Entrench, Stack, Fisticuffs and Mimic compute their block and say so outright.
        matches!(self.id, CardId::Entrench | CardId::Stack | CardId::Fisticuffs | CardId::Mimic) || self.vars().block > 0.0
    }
